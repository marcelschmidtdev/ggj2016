...
public class PlayerFollower : MonoBehaviour {
	...
	void FixedUpdate () {
        ...
        Vector3 screenShakeOffset = controls.screenShaker.transform.localPosition * shakeMultiplier;
        transform.LookAt(playerView.transform.position + playerView.transform.InverseTransformVector(lookAtOffset) + playerView.transform.InverseTransformVector(screenShakeOffset));
	}
}
